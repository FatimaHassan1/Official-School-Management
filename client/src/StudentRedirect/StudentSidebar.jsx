          ...
          <ul>
            <li>
              ...
              <label for='comp1'>
                  ...
                  <NavLink exact to='/studentdashbaord' style={{textDecoration:'none'}}>Dashboard</NavLink>
              </label>
            </li>
            
            <li>
              <input type='radio' name='menu' id='comp2'/>
              <label for='comp2'>
                  <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide "><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg></div>
                  <NavLink exact to='/all' style={{textDecoration:'none',}}>Request Forms</NavLink>
              </label>
            </li>
            
            <li>
              <input type='radio' name='menu' id='comp3'/>
              <label for='comp3'>
                  <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide "><line x1="22" y1="12" x2="2" y2="12"></line><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path><line x1="6" y1="16" x2="6.01" y2="16"></line><line x1="10" y1="16" x2="10.01" y2="16"></line></svg></div>
                  <NavLink exact to='/presentforms' style={{textDecoration:'none',}}>Present Forms</NavLink>
              </label>
            </li>
            ...
            <li>
              ...
              <label for='comp4'>
                  ...
                  <NavLink exact to='/leaveforms' style={{textDecoration:'none',}}>Leave Forms</NavLink>
              </label>
            </li>
            ...
            <li>
              ...
              <label for='comp4'>
                  <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide "><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg></div>
                  <NavLink exact to='/students' style={{textDecoration:'none',}}>Students</NavLink>
              </label>
            </li>
